...
@reaction_api.route('/add_reaction', methods=['POST'])
def add_reaction():
        data = request.json
...
@reaction_api.route('/get_reactions/<message_id>', methods=['GET'])
...
@reaction_api.route('/reset_reactions/<message_id>', methods=['DELETE'])
...
#api.add_resource(_REACTION, '/post')
